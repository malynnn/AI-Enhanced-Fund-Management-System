...
exports.PettyCashModule = PettyCashModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [prisma_service_1.PrismaService, petty_cash_service_1.PettyCashService],
        exports: [prisma_service_1.PrismaService, petty_cash_service_1.PettyCashService],
    })
], PettyCashModule);

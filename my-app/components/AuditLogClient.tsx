// src/components/AuditLogClient.tsx
"use client";
...
// 2. Accept initialLogs as a prop passed from the server
export default function AuditLogClient({ initialLogs }: { initialLogs: AuditLogProp[] }) {
  ...
  // --- FILTERING LOGIC (Now reading from your database prop!) ---
      ...
      <div className="bg-white shadow-sm border border-gray-200 flex-1 min-h-0 flex flex-col overflow-hidden rounded-b-xl">
        ...
        <div className="border-t border-gray-200 bg-gray-50 px-6 py-3 flex items-center justify-between flex-shrink-0">
          ...
          <div className="flex gap-2">
            <button disabled className="p-1.5 rounded-md border border-gray-200 bg-white text-gray-400 cursor-not-allowed hover:bg-gray-50 transition-colors">
              <ChevronLeft size={16} />
            </button>
            <button disabled className="p-1.5 rounded-md border border-gray-200 bg-white text-gray-400 cursor-not-allowed hover:bg-gray-50 transition-colors">
